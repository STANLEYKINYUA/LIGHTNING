package UI.Charts_and_Indicatorz.ChartManager;

/** This class is used to Open and Manage Charts_and_Indicatorz +  store Chart Settings + Chart Template Information */
public class Chart_Manager
{
    ...
    //Special Data Types to track which Charts_and_Indicatorz are open.
   private boolean[] Charts_Array = new boolean[30];
    ...
    public Chart_Manager()
    {
        ...
        // On Load : Read the Config Files and Determine Open Charts_and_Indicatorz if any
    ...
    // Chart Manager Functions that Open and Manage Number of Open Charts_and_Indicatorz
    public void Open_Chart(int Chart_Number ,String Symbol , String Chart_Type , int Period)
    {
        //Read Charts_and_Indicatorz Array and Determine Open Charts_and_Indicatorz
    ...
    //Chart Manager Supports Opening up to 30 Charts_and_Indicatorz which can be accessed by their Individual names
